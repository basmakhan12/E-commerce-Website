    ...
    <div>
      <div className='flex items-start max-w-screen-lg w-full mx-auto mt-10'>
        ...
        <div className='mt-2 mr-4'>
          ...
          <p className='text-xs text-black'>Explore our delicious menu and select meal.</p>
          </div>
          </div>
        ...
        <div className='mt-2 mr-4'>
          ...
          <p className='text-xs text-black'>Ready to eat? Proceed to chexkout and complete your order.</p>
          </div>
          </div>
